...
public class Utils {
    ...
    private static final String ACCENT_PREF = "com.iven.MusicApp.pref_accent";
    private static final String ACCENT_VALUE = "com.iven.MusicApp.pref_accent_value";
    private static final String THEME_PREF = "com.iven.MusicApp.pref_theme";
    private static final String THEME_VALUE = "com.iven.MusicApp.pref_theme_value";
